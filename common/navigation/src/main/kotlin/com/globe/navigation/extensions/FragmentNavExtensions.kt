package com.globe.navigation.extensions
...
/**
 * Navigate back to the starting destination of the nav graph
 */
fun Fragment.navigateToStartIfNotAtRootInNavGraph(navController: NavController = findNavController()) {
